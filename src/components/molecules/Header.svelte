...
<header>
    <div>
        <a href="/">shrey kumar</a>
    </div>
    <nav>
        <ul>
            <li><a href="#about"><span class="pink">01. </span>about</a></li>
            <li><a href="#experience"><span class="yellow">02. </span>experience</a></li>
            <li><a href="#work"><span class="blue">03. </span>work</a></li>
            <li><a href="#blog"><span class="green">04. </span>blog</a></li>
            <li><a href="#resume"><span class="pink">05. </span>resume</a></li>
            <li><a href="#contact"><span class="yellow">06. </span>contact</a></li>
        </ul>
    </nav>
    <div>
        <svg
